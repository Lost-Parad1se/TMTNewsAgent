...
- 已新增 Phase 13 Web Access Layer：`static`、`jina`、可选本地 `cdp`、本地浏览器历史匹配骨架。
...
config/
  ...
  web_access.yaml       # Web Access Layer 配置
...
- 支持 `LLM_PROVIDER=mock/gemini/qwen/deepseek/glm/openai-compatible`。
